...
function ContactUs() {
  ...
  <meta name="description" content="Contact Caross.in for unparalleled auto detailing services. Whether you have questions, want to schedule an appointment, or discuss your specific needs, our friendly team is ready to assist you. Experience excellence in automotive care with Caross.in."></meta>
     ...
     <div className="container-fluid nav-margin">
      ...
      <div className="row">
        <div className="col-12">
          ...
          <p>
          Thank you for considering Caross Car Detailing and Denting Painting Studio for your automotive needs. We value your interest and are here to provide you with exceptional service and support. Feel free to get in touch with us using the following contact details:
          </p>
          ...
          <ul>
            <li style={{listStyleType:'initial'}}> <a  href="tel:8929227077"><i class="fa-solid fa-phone-volume" style={{color:'#b8242a'}}></i> <span className='ms-3' style={{color:'black'}}> +91 8929227077</span></a></li>
            <li style={{listStyleType:'initial'}}><a  href="mailto:info@caross.in"> <i class="fa-solid fa-envelope" style={{color:'#b8242a'}}></i> <span style={{color:'black'}} className='ms-3'>  info@caross.in</span></a></li>
          </ul>
             </div>
            ...
            <div>
              ...
              <p >D 52 Street No 8 Rajnagar 2 Palam Colony South West Delhi DELHI 110077</p>
              </div>
        ...
        <div>
          <p>Thank you for considering us for your car care needs. We look forward to serving you and making your vehicle shine like new again.</p>
        </div>
      </div>
      </div>
     </div>
