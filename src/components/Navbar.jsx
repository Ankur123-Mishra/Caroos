...
function Navbar1() {
  ...
  useEffect(() => {
    if (
      ...
      location.pathname === "/services/18" ||
      location.pathname === "/services/19" ||
      location.pathname === "/services/20" ||
      location.pathname === "/services/21"
    ) {
      setPath(true);
    } else {
      setPath(false);
  ...
  return (
    <>
      <div className={isAboveMessageShow ? "nav-shadow  " : null}>
        {isAboveMessageShow ? (
          <div
            className="row   mb-0 p-0 border-bottom position-relative"
            style={{
              cursor: "pointer",
              background:
          ...
          >
            <div
              ...
              className="col-12 d-flex  justify-content-end align-items-center position-relative"
            >
              <marquee
      ...
      Get a free pre delivery inspection now  &nbsp; 
       <Link to="/pre-delivery-inspection" style={{fontSize:'13px', color:'#b8242a'}}>Explore...</Link>
        ...
        <Navbar
          ...
          className={
            path
              ? "px-1 mt-0 bg-white navbar navbar-expand-lg nav-shadow nav-container"
              : isAboveMessageShow
              ? " px-1 bg-white navbar navbar-expand-lg nav-conainer"
              : "nav-shadow px-1 bg-white navbar fixed-top navbar-expand-lg nav-conainer"
          }
        >
          {/* <Container> */}
          <NavLink
            className="navbar-brand ms-md-3"
            onClick={onScrollingTop}
            to="/"
          >
            <img
          ...
          <Navbar.Collapse
            ...
            className="basic-navbar-nav bg-white "
            style={{ zIndex: "10" }}
          >
            ...
            <Nav className="ms-auto pe-2 pe-md-0">
              ...
              <Nav.Link href="https://caross.in/blog/">
                <a
                  href="https://caross.in/blog/"
                  className="nav-link nav-text"
                  target="_blank"
                >
                  Blog
            ...
            <Nav className="ms-auto me-md-3 g-md-4 pe-2 ps-md-0">
              {userToken && (
                <Nav.Link className="mt-md-1 text-end">
                  <a
              ...
              {userToken ? (
                <>
                  <NavDropdown
                    title="Profile"
                    className="nav-text mt-0 mt-md-2 mx-0 mx-md-4 text-end"
